                    ...
                    <div class="col-md-7">
                        <div class="page-breadcrumb-wrap">
                            <div class="page-breadcrumb-info">
                                <h2 class="breadcrumb-titles" >创建虚拟路牌<small> 面板 </small>   </h2>
                                <ul class="list-page-breadcrumb">
                                    <li><a href="#">Home</a>
                                    </li>
                                    <li><a href="#"> 虚拟路牌列表 </a>
                                    </li>
                                    <li class="active-page"> 创建虚拟路牌</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="widget-container">
                            <div class=" widget-block">
                                <div class="page-header">
                                    <h2 class="font"> 创建虚拟路牌 </h2>
                                    <p class="font">
                                        在这里你可以创建新的虚拟路牌。
                                    </p>
                                </div>
                                <form id="SignUpForm"  class="form-horizontal" action="{{url('admin/roadStore')}}" method="post" >
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label font">虚拟路牌名称</label>
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control" name="title" placeholder="虚拟路牌名称"/>
                                        </div>
                                    </div>
                                    {{--<div class="form-group"  id="mp">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="hidden" class="form-control inputMap"   name="pic" placeholder="虚拟路牌图片" value=""/>
                                        </div>
                                    </div>--}}
                                    ...
                                    <div class="form-group" id="mu" >
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <input type="hidden" class="form-control music"   name="music" placeholder="虚拟路牌音频" value=""/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="hidden" name="isRoad" value="1">
                                    <div class="form-group">
