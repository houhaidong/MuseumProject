                ...
                <tbody>
                    @foreach($data as $key => $item)
                        <tr>
                            ...
                            <td class="tc-center font" >
                              <input class="sorting form-control"   name="sorting"  type="text" key='{{$item->id}}'   value="{{$item->sorting}}">
                            </td>
...
@section("js")
    ...
    $(function(){
            ...
            $(".sorting").change(function(){
                    ...
                    var exhibit_id = $(this).attr("key")
                    $.ajax({
                        url:"/admin/sort/edit",
                        data:"sorting="+sorting+"&exhibit_id="+exhibit_id,
                        type:"post",
