...
<div class="main-container">
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div id="map2" style="width: 100%;height:500px;border: 1px solid #bdbdbd;margin: 0 auto;display: none;"></div>
      </div>
      <div style="width: 100%;height: 30px;text-align: center;margin-top: 15px;">
             <div style="margin: 0 auto;" class="pagination">
              ...
              <li id="two">
                  <span><a href="{{asset('admin/changMap')}}">三层</a></span>
              </li>
             </div>
      </div>
    </div>
