            ...
            <div class="widget-block">
                <div class="table-responsive">
                    ...
                    <div id="" style="width: 100%;">
                        <div id="main" style="width: 600px;height: 300px;margin: 0 auto">
...
<script type="text/javascript">
    ...
    function chaxun(){
        ...
        $.ajax({
            url: 'ajaxTime'+'/starttime/'+startTime+'/endtime/'+endTime+'/exhibitid/'+str,
            ...
            success: function (e) {
                ...
                str +='</tr></thead><tbody><tr><td class="tc-center font">平均停留时间(秒)</td>';
                data.forEach(function(index,item) {
