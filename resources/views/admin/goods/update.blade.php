				...
				<div class="row">
					<div class="col-md-12">
						<div class="box-widget widget-module no-border">
							...
							<form id="SignUpForm"  class="form-horizontal" action="{{url('admin/editGood').'/'.$data->id}}" method="post" onsubmit="return checkData()" >
                                        {{csrf_field()}}
										...
										<div class="form-group"  id="mp">
											...
											<div class="col-lg-4">	
												...
												<input id="pic" type="hidden" class="form-control inputMap"   name="pic" placeholder="展品图片" value="{{$pic->resource_name}}"/>
											</div>
										</div>
										...
										<div class="form-group" id="mu" >
											...
											<div class="col-lg-5">
												...
												@endif
													...
													<input id="music" type="hidden" class="form-control music"   name="music" placeholder="展品音频" value="{{$music->resource_name}}"/>
													</div>
										</div>
											...
											<div class="col-lg-4">
												<select class="form-control" name="map">
													@foreach($project as $v)
															<option value="{{$v->id}}" {{$data->map == $v->id ? 'selected' : ''}}>{{$v->pname}}</option>
													@endforeach
												</select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-lg-4">
												<input type="text" class="form-control" name="ARURL" value="{{$data->url}}" placeholder="VR链接"/>
											</div>
										</div>
