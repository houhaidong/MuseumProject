...
class ProjectController extends Controller
{
    ...
    public function goods($id)
    {
        ...
        $data = Exhibit::where("project_id",$id)->orderBy("sorting","asc")->get();
     ...
     public function sorting_edit(Request $request)
    {

         $sorting = $request->input("sorting");
         $exhibit_id = $request->input("exhibit_id");
         $exhibit = Exhibit::find($exhibit_id);
         $exhibit->sorting = $sorting;
         $exhibit->save();          
